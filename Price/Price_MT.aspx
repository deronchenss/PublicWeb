                    ...
                    success: function (response) {
                        $('#Table_Search_Price').DataTable({
                            ...
                            "columns": [
                                ...
                                { data: "PRI", title: "<%=Resources.Price.Price_Information%>" },
            ...
            $('#SPD_Table_Product').on('click', '.BTN_Green', function () {
                switch (PS_Control) {
                    case "NU"://New&Update
                        ...
                        break;
                    case "C"://Copy
                        $('#HDN_CD_P_SEQ').val($(this).parent().parent().find('td:nth(1)').text());
    ...
    <div id="Copy_Dialog" style="display:none;">
        <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 0px;" id="CD_Table">
            ...
            <tr style="background-color:lightgray;">
                <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Cost.Old%><%=Resources.Price.SEQ%></td>
                <td style="text-align: left; width: 15%;">
                    <span id="LB_CD_SEQ"></span>
                </td>
                <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Cost.Old%><%=Resources.Price.Customer_Model%></td>
                <td style="text-align: left; width: 15%;">
                    <span id="LB_CD_CM"></span>
                </td>
            </tr>
            <tr style="background-color:lightgray;">
                <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Cost.Old%><%=Resources.Price.Customer_No%></td>
                <td style="text-align: left; width: 15%;">
                    <span id="LB_CD_C_No"></span>
                </td>
                <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Cost.Old%><%=Resources.Price.Customer_Short_Name%></td>
                <td style="text-align: left; width: 15%;">
            ...
            <tr style="background-color:lightgray;">
                ...
                <td style="text-align: right; text-wrap: none; width: 10%;">
                    <%=Resources.Cost.Old%><%=Resources.Cost.Supplier_No%>
                    <br />
                    <%=Resources.Cost.Old%><%=Resources.Cost.Supplier_Short_Name%>
                </td>
                <td style="text-align: left; width: 15%;">
            ...
            <tr>
                <td style="text-align:right;"><%=Resources.Cost.New%><%=Resources.Price.Customer_Model%></td>
                <td style="text-align: left; width: 15%;">
                    <input id="TB_CD_CM" required="required" autocomplete="off" style="width: 100%;" />
                </td>
            </tr>   
            <tr>
                <td style="text-align:right;"><%=Resources.Cost.New%><%=Resources.Price.Customer_No%></td>
                ...
                <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Cost.New%><%=Resources.Price.Customer_Short_Name%></td>
                <td style="text-align: left; width: 15%;" colspan="3">
                    <input id="TB_CD_C_SName" class="disabled" disabled="disabled" style="width: 100%;" />
                </td>
            </tr>
            <tr>
                <td style="text-align:right;"><%=Resources.Cost.New%><%=Resources.Price.Ivan_Model%></td>
                <td style="text-align:left;">
                    <div style="width: 90%; float: left; z-index: -10;">
                        <input id="TB_CD_IM" class="disabled" required="required" disabled="disabled" style="width: 100%;" />
                        <input type="hidden" id="HDN_CD_P_SEQ" />
                    </div>
                    <div style="width: 10%; float: right; z-index: 10;">
                ...
                <td style="text-align: right; text-wrap: none; width: 10%;">
                    <%=Resources.Cost.New%><%=Resources.Price.Supplier_No%>
                    <br />
                    <%=Resources.Cost.New%><%=Resources.Cost.Supplier_Short_Name%>
                </td>
                <td style="text-align: left; width: 15%;">
        ...
        <div id="Div_M2" class="Div_D">
            <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 8px;">
                <tr style="display:none;" class="M2_For_V">
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Price.SEQ%></td>
                    <td style="text-align: left; width: 15%;" colspan="3">
                ...
                <tr>
                    ...
                    <td style="text-align: right; text-wrap: none; width: 10%;">
                        <%=Resources.Price.Supplier_No%>
                        <br />
                        <%=Resources.Cost.Supplier_Short_Name%>
                    </td>
                    <td style="text-align: left; width: 15%;" colspan="3">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Price.Price_Information%></td>
