...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    */
                    ...
                    function Search_Customer() {
                        $.ajax({
                            ...
                            success: function (response) {
                                var Table_HTML =
                                    '<thead><tr><th>' + '<%=Resources.Customer.Customer_No%>'
                                    + '</th><th>' + '<%=Resources.Customer.Customer_Short_Name%>'
                                    + '</th><th>' + '<%=Resources.Customer.Costomer_Source%>'
                                    + '</th><th>' + '<%=Resources.Customer.Quote_Class%>'
                                    + '</th><th>' + '<%=Resources.Customer.Tel%>'
                                    + '</th><th>' + '<%=Resources.Customer.Fax%>'
                                    + '</th><th>' + '<%=Resources.Customer.Person_Commodity%>'
                                    + '</th><th>' + '<%=Resources.Customer.Person_Sample%>'
                                    + '</th><th>' + '<%=Resources.Customer.Nation%>'
                                    + '</th><th>' + 'Mail'
                                    + '</th><th>' + '<%=Resources.Customer.SEQ%>'
                                    + '</th><th>' + '<%=Resources.Customer.Update_User%>'
                                    + '</th><th>' + '<%=Resources.Customer.Update_Date%>'
                                    + '</th></tr></thead><tbody>';
                                ...
                                $('#Table_Customer').DataTable({
                                    ...
                                    "columns": [
                                        ...
                                        { data: "C_Source", title: "<%=Resources.Customer.Costomer_Source%>" },
    ...
    <div style="width: 99%; margin: 0 auto; background-color: white;">
        ...
        <input type="button" class="V_BT" IVMD_PERMISSIONS="1" value="<%=Resources.Customer.TW_Customs_Clearance%>" onclick="$('.Div_D').css('display','none');$('#Div_TW_Customs_Clearance').css('display','');" />
        <input type="button" class="V_BT" IVMD_PERMISSIONS="2" value="<%=Resources.Customer.HK_Customs_Clearance%>" onclick="$('.Div_D').css('display','none');$('#Div_HK_Customs_Clearance').css('display','');" />
        <input type="button" class="V_BT" value="<%=Resources.Customer.Marks%>" onclick="$('.Div_D').css('display','none');$('#Div_Marks').css('display','');" />
        <input type="button" class="V_BT" value="<%=Resources.Customer.Remark%>" onclick="$('.Div_D').css('display','none');$('#Div_Remark').css('display','');" />
