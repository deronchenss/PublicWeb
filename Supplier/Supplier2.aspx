<%@ Page Title="Supplier Maintenance" Language="C#" MasterPageFile="~/MP.master" AutoEventWireup="true" CodeFile="Supplier2.aspx.cs" Inherits="Supplier_Supplier2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        $(document).ready(function () {
            ...
            $('#BT_New_Save').on('click', function () {
                if (confirm("<%=Resources.MP.Save_Alert%>")) {
                    if (Save_Check()) {
                        $.ajax({
                            url: "/Supplier/Supplier_Save.ashx",
                            data: {
                                "S_No": $('#TB_M2_S_No').val(),
                            ...
                            success: function (response) {
                                ...
                                if (String(response).indexOf("UNIQUE KEY") > 0) {
                                    ...
                                    alert("<%=Resources.Supplier.Add_Success%>");
                    ...
                    success: function (response) {
                        ...
                        $('#Table_Search_Customer').DataTable({
                            ...
                            "columns": [
                                ...
                                { data: "S_SName", title:"<%=Resources.Supplier.Supplier_Short_Name%>" },
                                { data: "S_Tel", title: "<%=Resources.Supplier.Tel%>" },
                                { data: "S_FAX", title: "<%=Resources.Supplier.Fax%>" },
                                ...
                                { data: "S_EIN", title: "<%=Resources.Supplier.EIN%>" },
    ...
    <div id="dialog" style="display: none;">
        ...
        <table border="0" style="margin: 0 auto;" id="Dia_Table_Simple">
            <tr style="text-align: right;">
                <td style="width: 20%;"><%=Resources.Supplier.Supplier_NO%></td>
                <td style="width: 30%;">
            ...
            <tr style="text-align: right;">
                <td style="width: 20%;"><%=Resources.Supplier.Supplier_Short_Name%></td>
                <td style="width: 30%;">
            ...
            <tr style="text-align: center;">
                <td style="width: 40%;">
                    ...
                    <select style="width: 90%; height: 25px;" id="DDL_Dia_Filter">
                        <option value="[廠商編號]" selected="selected"><%=Resources.Supplier.Supplier_NO%></option>
                        <option value="[廠商簡稱]"><%=Resources.Supplier.Supplier_Short_Name%></option>
                        <option value="[電話]"><%=Resources.Supplier.Tel%></option>
                        <option value="[傳真]"><%=Resources.Supplier.Fax%></option>
                        <option value="[連絡人採購]"><%=Resources.Supplier.Purchase_Person%></option>
                        <option value="[連絡人開發]"><%=Resources.Supplier.Develop_Person%></option>
                        <option value="[負責人]"><%=Resources.Supplier.Principal%></option>
                        <option value="[統一編號]"><%=Resources.Supplier.EIN%></option>
                        <option value="[序號]"><%=Resources.Supplier.SEQ%></option>
                        <option value="[更新人員]"><%=Resources.Supplier.Update_User%></option>
                        <option value="[更新日期]"><%=Resources.Supplier.Update_Date%></option>
    ...
    <div style="width: 99%; margin: 0 auto; background-color: white;">
        &nbsp;
        <input id="V_BT_Master" type="button" class="V_BT" value="<%=Resources.Supplier.Master%>" onclick="$('.Div_D').css('display','none');$('#Div_M2').css('display','');" disabled="disabled" />
        <input type="button" class="V_BT" style="display:none;" value="<%=Resources.Supplier.Remark%>" onclick="$('.Div_D').css('display','none');$('#Div_Remark').css('display','');" />
        <input type="button" class="V_BT" style="display:none;" value="<%=Resources.Supplier.Domestic_Payment%>" onclick="$('.Div_D').css('display','none');$('#Div_Domestic_Payment').css('display','');" />
        <input type="button" class="V_BT" style="display:none;" value="<%=Resources.Supplier.Overseas_Payment%>" onclick="$('.Div_D').css('display','none');$('#Div_Overseas_Payment').css('display','');" />
        <input type="button" class="V_BT" style="display:none;" value="<%=Resources.Supplier.Example%>" onclick="$('.Div_D').css('display','none');$('#Div_Example').css('display','');" />
    </div>
    <div style="width: 100%;" id="Div_Detail_Form">
        <div id="Div_M2" class="Div_D">
            <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 8px;">
                <tr>
                    ...
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Tel%></td>
                    <td style="text-align: left; width: 15%;">
                ...
                <tr>
                    ...
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Fax%></td>
                    <td style="text-align: left; width: 15%;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Account_Class%></td>
                    <td style="text-align: left; width: 15%;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;">*<%=Resources.Supplier.Nation%></td>
                    <td style="text-align: left; width: 15%;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Currency%></td>
                    <td style="text-align: left; width: 15%;">
        ...
        <div id="Div_Remark" class="Div_D" style="display: none; overflow: auto;">
            <table style="font-size: 15px;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Purchase%></td>
                ...
                <tr><td><br /></td></tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Develop%></td>
        ...
        <div id="Div_Domestic_Payment" class="Div_D" style="display: none; overflow: auto;">
            <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 10px;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Payment_Mode%></td>
                    <td style="text-align: left; width: 15%;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Bank_Head_Code%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_DP_Bank_Head_Code" disabled="disabled" style="width: 100%; " />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Bank_Branch_Code%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_DP_Bank_Branch_Code" disabled="disabled" style="width: 100%; " />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Collect_Account%></td>
                    <td style="text-align: left; width: 15%;" colspan="3">
                        <input id="TB_DP_Collect_Account" disabled="disabled" style="width: 100%; " />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Collect_Name%></td>
                    <td style="text-align: left; width: 15%;" colspan="3">
                        <input id="TB_DP_Collect_Name" disabled="disabled" style="width: 100%; " />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Collect_EIN%></td>
                    <td style="text-align: left; width: 15%;" colspan="3">
                        <input id="TB_DP_Collect_EIN" disabled="disabled" style="width: 100%; " />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Collect_Mail%></td>
                    <td style="text-align: left; width: 15%;" colspan="3">
        ...
        <div id="Div_Overseas_Payment" class="Div_D" style="display: none; overflow: auto;">
            <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 10px;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Collect_Nation%></td>
                    <td style="text-align: left; width: 15%;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Collect_Address%></td>
                    <td style="text-align: left;width:90%;" colspan="3">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Collect_Bank_Name%></td>
                    <td style="text-align: left;width:90%;" colspan="3">
                        <textarea id="TB_OP_Collect_Bank_Name" style="width: 100%; height: 50px;" disabled="disabled"></textarea>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.Supplier.Collect_Bank_Address%></td>
                    <td style="text-align: left;width:90%;" colspan="3">
