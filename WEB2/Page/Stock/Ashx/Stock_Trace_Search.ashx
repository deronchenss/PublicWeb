<%@ WebHandler Language="C#" Class="Stock_Trace_Search" %>
...
public class Stock_Trace_Search : IHttpHandler, IRequiresSessionState
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (!string.IsNullOrEmpty(context.Request["Call_Type"]))
        {
            try
            {
                ...
                {
                    case "SEARCH":
                        result = JsonConvert.SerializeObject(service.StockIOTraceSearch(ContextFN.ContextToDictionary(context)));
                        break;
                    case "SEARCH_DETAIL":
