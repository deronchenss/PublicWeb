...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="table_th">
        ...
        <tr>
            <td style="text-align: right; text-wrap: none; width: 10%;"><%--廠商編號--%><%=Resources.MP.Supplier_No%></td>
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                var Table_HTML =
                                    ...
                                    + '</th><th>' + '<%=Resources.MP.Area%>'
                                    + '</th><th>' + '<%=Resources.MP.Nation%>'
                                    + '</th><th>' + '<%=Resources.MP.Z%>'
                                    + '</th><th>' + '<%=Resources.MP.Phone%>'
                                    + '</th><th>' + '<%=Resources.MP.Company_Address%>'
                                    + '</th><th>' + '<%=Resources.MP.Factory_Address%>'
                                ...
                                $('#GV_Supplier').DataTable({
                                    ...
                                    "columns": [
                                        ...
                                        { data: "S_Name", title: "<%=Resources.MP.Supplier_Short_Name%>" },
                                        ...
                                        { data: "S_Area", title: "<%=Resources.MP.Area%>" },
                                        { data: "S_Nation", title: "<%=Resources.MP.Nation%>" },
                                        { data: "S_Z", title: "<%=Resources.MP.Z%>" },
                                        { data: "S_Phone", title: "<%=Resources.MP.Phone%>" },
                                        { data: "S_Company_Address", title: "<%=Resources.MP.Company_Address%>" },
                                        { data: "S_Factory_Address", title: "<%=Resources.MP.Factory_Address%>" },
    ...
    <div style="width: 98%; margin: 0 auto;">
        ...
        <asp:Panel ID="P_Bank" CssClass="P_D" runat="server" ScrollBars="Auto" Style="display: none;">
            <table style="font-size: 15px;border-collapse:separate; border-spacing:0px 10px;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Bank_Name%></td>
                    <td colspan="3" style="text-align: left; width: 15%;">
                        <input id="TB_B_Account_Head" placeholder="" style="width: 100%;" type="email" disabled="disabled" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Bank_Account_Header%></td>
                    <td colspan="3" style="text-align: left; width: 15%;">
                        <input id="TB_B_Bank_Name" placeholder="" style="width: 100%;" type="email" disabled="disabled" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Bank_Address%></td>
                    <td colspan="3" style="text-align: left; width: 15%;">
                        <input id="TB_B_Bank_Address" placeholder="" style="width: 100%;" type="email" disabled="disabled" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Bank_Account%></td>
                    <td colspan="3" style="text-align: left; width: 15%;">
