...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var Edit_Mode = "Base";
            var apiUrl = "/Page/DEV/Sample/Ashx/Sample_Arr_MT.ashx";
            //隱藏滾動卷軸
                    ...
                    success: function (response) {
                        if (response.length === 0) {
                            ...
                            $('#Table_Search_Recu').DataTable({
                                ...
                                "columnDefs": [
                                    {
                                        className: 'text-right', targets: [6] //數字靠右
                                    },
                                ],
    ...
    <div style="width:98%;margin:0 auto; ">
        <div class="search_section_all">
            ...
            <tr class="trstyle">
                ...
                <td class="tdbstyle">
                    <input id="Q_ARR_DATE_S" type="date" class="date_S_style TB_DS" /><input id="Q_ARR_DATE_E" type="date" class="date_E_style TB_DE" />
