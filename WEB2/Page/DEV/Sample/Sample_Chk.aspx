...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var Edit_Mode;
            var apiUrl = "/Page/DEV/Sample/Ashx/Sample_Chk.ashx";
            //隱藏滾動卷軸
    ...
    <div style="width:98%;margin:0 auto; ">
        <div class="search_section_all">
            ...
            <tr class="trstyle">
                ...
                <td class="tdbstyle">
                    <input id="Q_PUDU_GIVE_DATE_S" type="date" class="date_S_style TB_DS" /><input id="Q_PUDU_GIVE_DATE_E" type="date" class="date_E_style TB_DE" />
            ...
            <div id="Div_Exec_Section" style="width:28%;height:71vh; border-style:solid;border-width:1px; float:right;">
                <table class="search_section_control" style="width:auto">
                    ...
                    <tr class="trCenterstyle">
                        ...
                        <td class="tdbstyle">
                            <input id="E_CHK_BATCH_NO" maxlength="9"  class="textbox_char" />
                        </td>
                    </tr>
                    <tr class="trCenterstyle">
                        <td class="tdhstyle" style="font-size:20px">運輸編號</td>
                        <td class="tdbstyle">
                            <input id="E_TRANS_WAY_NO"  class="textbox_char" disabled="disabled"  />
                            <input id="BT_TRANS_WAY" style="font-size:20px" type="button" value="..." />
                        </td>
                    </tr>
                    <tr class="trCenterstyle">
                        <td class="tdhstyle"></td>
                        <td class="tdbstyle" colspan="2">
                            <input id="E_TRANS_WAY"  class="textbox_char" disabled="disabled"  />
                        </td>
                    </tr>
                    <tr class="trstyle"> 
