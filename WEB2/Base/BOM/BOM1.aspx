...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    success: function (response) {
                        $('#Table_Search_BOM').DataTable({
                            ...
                            "columns": [
                                ...
                                { data: "F_S_No", title: "<%=Resources.MP.Final_Supplier%>" },
                                { data: "F_S_SName", title: "<%=Resources.MP.Supplier_Short_Name%>" },
                                { data: "Mark", title: "<%=Resources.MP.Mark%>" },
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        var D_Table_HTML =
                            ...
                            + '</th><th>' + '<%=Resources.MP.D_SEQ%>'
                            + '</th><th>' + '<%=Resources.MP.Parent_SEQ%>'
                            ...
                            + '</th><th>' + '<%=Resources.MP.TWD_Price%>'
                            + '</th><th>' + '<%=Resources.MP.USD_Price%>'
                            + '</th><th>' + '<%=Resources.MP.Material_Supplier_ALL%>'
                            + '</th><th>' + '<%=Resources.MP.Stop_Date%>'
                            + '</th><th>' + '<%=Resources.MP.Material_Sell%>'
                            + '</th><th>' + '<%=Resources.MP.Not_Billing%>'
                            + '</th><th>' + '<%=Resources.MP.Not_Expand%>'
                            + '</th><th>' + '<%=Resources.MP.Not_Computing_Cost%>'
                        ...
                        $(response).each(function (i) {
                            ...
                            var Add_BT = "<span class='D_T_ADD' style='cursor:pointer;color:green;'><%=Resources.MP.Add_Item%></span>";
                            ...
                            D_Table_HTML +=
                                ...
                                ((response[i].HASIMG) ? ('<img src="data:image/png;base64,' + window.btoa(binary) + '" />') : ('<%=Resources.MP.Image_NotExists%>')) +
    ...
    <div id="dialog" style="display: none;">
        ...
        <table border="0" style="margin: 0 auto;" id="Dia_Table_Simple">
            ...
            <tr style="text-align: right;">
                <td style="width: 20%;"><%=Resources.MP.Master_Supplier_ALL%></td>
                <td style="width: 30%;">
            ...
            <tr style="text-align: center;">
                <td style="width: 40%;">
                    ...
                    <select style="width: 90%; height: 25px;" id="DDL_Dia_Filter">
                        ...
                        <option value="[完成者簡稱]"><%=Resources.MP.Master_Supplier_S_Name%></option>
    ...
    <div id="Copy_Dialog" style="display: none;">
        <div style="position: relative; border: 1px solid #111111; padding: 20px; box-sizing: border-box; margin: 30px auto; width: 100%;background-color:silver;">
            ...
            <table style="border-collapse: separate; border-spacing: 0px 8px; margin: 0 auto;width:100%;" id="CD_Old_Table">
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Old_Master_SEQ%></td>
                    <td style="text-align: left; width: 15%;">
                        <input style="width: 80%;" id="CD_TB_OLD_SEQ" class="disable" disabled="disabled" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Old_Ivan_Model%></td>
                    <td style="text-align: left; width: 15%;">
                        <input style="width: 80%;" id="CD_TB_OLD_IM" class="disable" disabled="disabled" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Old_Supplier%></td>
                    <td style="text-align: left; width: 15%;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Old_Product_Information%></td>
    ...
    <div id="New_Detail_Dialog" style="display:none;">
        <div style="position: relative; border: 1px solid #111111; padding: 20px; box-sizing: border-box; margin: 30px auto; width: 100%;background-color:silver;">
            ...
            <table style="border-collapse: separate; border-spacing: 0px 8px; margin: 0 auto;width:100%;" id="NDD_Old_Table">
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Parent_SEQ%></td>
                    <td style="text-align: left; width: 15%;">
                        <input style="width: 80%;" id="NDD_TB_OLD_SEQ" class="disable" disabled="disabled" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Parent_Model%></td>
                    <td style="text-align: left; width: 15%;">
                        <input style="width: 80%;" id="NDD_TB_OLD_IM" class="disable" disabled="disabled" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Parent_Supplier%></td>
                    <td style="text-align: left; width: 15%;">
                        <input style="width: 80%;" id="NDD_TB_OLD_Supplier" class="disable" disabled="disabled" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Parent_Rank%></td>
                    <td style="text-align: left; width: 15%;">
                        <input style="width: 100%;" id="NDD_TB_OLD_Rank" class="disable" disabled="disabled" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Parent_Product_Information%></td>
                    <td style="text-align: left; width: 15%;" colspan="7">
        ...
        <div style="position: relative; border: 1px solid #111111; padding: 20px; box-sizing: border-box; margin: 30px auto; width: 100%;">
            ...
            <table style="border-collapse: separate; border-spacing: 0px 8px; margin: 0 auto;width:100%;" id="NDD_New_Table">
                <tr>
                    ...
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Material_Amount%></td>
                    <td style="text-align: left; width: 15%;">
        ...
        <div id="Div_M2" class="Div_D">
            <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 8px;">
                ...
                <tr>
                    ...
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Master_Supplier_S_No%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_M2_FNS" class="disable" disabled="disabled" style="width: 90%;" />
                    </td>

                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Master_Supplier_S_Name%></td>
                    <td style="text-align: left; width: 15%;">
                ...
                <tr class="M2_For_U" style="display: none;">
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.D_Count%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_M2_D_Count" class="disable" disabled="disabled" style="text-align:right;width: 90%;" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.SUM_TWD%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_M2_D_SUM_TWD" class="disable" disabled="disabled" style="width: 90%;text-align:right;" />
                    </td>

                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.SUM_USD%></td>
                    <td style="text-align: left; width: 15%;">
