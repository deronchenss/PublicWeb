            ...
            <div style="position: relative; border: 1px solid #111111; padding: 20px; box-sizing: border-box; margin: 30px auto; width: 90%;">
                ...
                <table style="margin: 0 auto; width: 100%;" id="Reset_Area_Table">
                    ...
                    <%--商標欄位暫時取消
                        ...
                        <td style="text-align: left; width: 30%;">
                            <div style="width: 80%; float: left; z-index: -10;">
                                <input id="RAT_TB_TM_Status" autocomplete="off" style="width: 100%; z-index: -10;" />
                            </div>
                            <div style="width: 20%; float: left; z-index: 10;">
                                <input id="RAT_BT_MS_RS" type="button" value="Reset" style="float: left; z-index: 10;" />
                            </div>
                        </td>
                        <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Trademark%><%=Resources.MP.Speace%><%=Resources.MP.Enable%></td>
                        <td style="text-align: left; width: 30%;">
                            <div style="width: 80%; float: left; z-index: -10;">
                                <input id="RAT_TB_TM_Enable" type="number" min="0" step="0.1" autocomplete="off" style="width: 100%; z-index: -10;" />
                            </div>
                            <div style="width: 20%; float: right; z-index: 10;">
                                <input id="RAT_BT_ME_RS" type="button" value="Reset" style="float: left; z-index: 10;" />
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Trademark%><%=Resources.MP.Speace%><%=Resources.MP.Process%></td>
                        <td style="text-align: left; width: 30%;">
                            <div style="width: 80%; float: left; z-index: -10;">
                                <input id="RAT_TB_TM_Process" autocomplete="off" style="width: 100%; z-index: -10;" />
                            </div>
                            <div style="width: 20%; float: left; z-index: 10;">
                                <input id="RAT_BT_MP_RS" type="button" value="Reset" style="float: left; z-index: 10;" />
                            </div>
                        </td>
                        <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Trademark%><%=Resources.MP.Speace%><%=Resources.MP.Word_Type%></td>
                        <td style="text-align: left; width: 30%;">
                            <div style="width: 80%; float: left; z-index: -10;">
                                <input id="RAT_TB_TM_Font_Type" type="number" min="0" step="0.1" autocomplete="off" style="width: 100%; z-index: -10;" />
                            </div>
                            <div style="width: 20%; float: right; z-index: 10;">
                                <input id="RAT_BT_MFT_RS" type="button" value="Reset" style="float: left; z-index: 10;" />
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Trademark%><%=Resources.MP.Speace%><%=Resources.MP.Word_Size%></td>
                        <td style="text-align: left; width: 30%;">
                            <div style="width: 80%; float: left; z-index: -10;">
                                <input id="RAT_TB_TM_Font_Size" autocomplete="off" style="width: 100%; z-index: -10;" />
                            </div>
                            <div style="width: 20%; float: left; z-index: 10;">
                                <input id="RAT_BT_MFS_RS" type="button" value="Reset" style="float: left; z-index: 10;" />
                            </div>
                        </td>
                        <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Trademark%><%=Resources.MP.Speace%><%=Resources.MP.Remark%></td>
                        <td style="text-align: left; width: 30%;">
                            <div style="width: 80%; float: left; z-index: -10;">
                                <input id="RAT_TB_TM_Remark" type="number" min="0" step="0.1" autocomplete="off" style="width: 100%; z-index: -10;" />
                            </div>
                            <div style="width: 20%; float: right; z-index: 10;">
