<%@ Page Title="Product Maintenance" Language="C#" MasterPageFile="~/MP.master" AutoEventWireup="true" CodeFile="Cost_MT.aspx.cs" Inherits="Cost_Cost_MT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#M2_BT_Product_Selector, #CD_BT_Product_Selector').on('click', function () {
            ...
            function Form_Mode_Change(Form_Mode) {
                switch (Form_Mode) {
                    ...
                    case "Edit_M":
                        ...
                        $('#Div_Detail_Form input, #Div_Detail_Form textarea, #Div_Detail_Form select').not('#TB_M2_Update_User, #TB_M2_Update_Date, #TB_M2_SEQ, .S_Name, .disabled').attr('disabled', false);
                        break;
                }
            }
                    ...
                    if (Save_Check()) {
                        $.ajax({
                            ...
                            data: {
                                ...
                                "Unit": $('#TB_M2_Unit').val(),
                                "PI": $('#TB_M2_P_IM').val(),
                                "P_TWD": parseFloat($('#TB_M2_TWD_1').val()) || 0,
                                "P_USD": parseFloat($('#TB_M2_USD').val()) || 0,
                                "P_TWD_2": parseFloat($('#TB_M2_TWD_2').val()) || 0,
                                "P_TWD_3": parseFloat($('#TB_M2_TWD_2').val()) || 0,
                                ...
                                "P_Curr": parseFloat($('#TB_M2_PC_1').val()) || 0,
                                "P_Curr_2": parseFloat($('#TB_M2_PC_2').val()) || 0,
                                "P_Curr_3": parseFloat($('#TB_M2_PC_3').val()) || 0,
                                "DS_P": $('#DDL_M2_DP').val(),
                                "DS_IM": $('#TB_M2_DI').val(),
                                "RP": $('#TB_M2_RP').val(),
                                "RD": $('#TB_M2_RD').val(),
            ...
            $('#SSD_Table_Supplier').on('click', '.SUP_SEL', function () {
                $('#TB_M2_S_No').val($(this).parent().parent().find('td:nth(2)').text());
                $('#TB_M2_S_SName').val($(this).parent().parent().find('td:nth(3)').text());
                $('#TB_CD_S_No').val($(this).parent().parent().find('td:nth(2)').text());
                $('#HDN_CD_S_SName').val($(this).parent().parent().find('td:nth(3)').text());
                    ...
                    if (Save_Check()) {
                        $.ajax({
                            ...
                            data: {
                                ...
                                "MS": $('#TB_MR_MS').val(),
                                "WH": parseFloat($('#TB_P_WH').val()) || 0,
                                "IBC": parseFloat($('#TB_P_IBC').val()) || 0,
                                "OBNo": parseFloat($('#TB_P_OBNo').val()) || 0,
                                "NW": parseFloat($('#TB_P_NW').val()) || 0,
                                "OBL": parseFloat($('#TB_P_OBL').val()) || 0,
                                "GW": parseFloat($('#TB_P_GW').val()) || 0,
                                "IA": parseFloat($('#TB_P_IA').val()) || 0,
                                "OBW": parseFloat($('#TB_P_OBW').val()) || 0,
                                "OBH": parseFloat($('#TB_P_OBH').val()) || 0,
                                "IA2": parseFloat($('#TB_P_IA2').val()) || 0,
                                "P_NW": parseFloat($('#TB_P_P_NW').val()) || 0,
                                "P_GW": parseFloat($('#TB_P_P_GW').val()) || 0,
                                "PL": parseFloat($('#TB_P_PL').val()) || 0,
                                "PW": parseFloat($('#TB_P_PW').val()) || 0,
                                "PH": parseFloat($('#TB_P_PH').val()) || 0,
                    ...
                    success: function (response) {
                        $('#Table_Search_Customer').DataTable({
                            ...
                            "columns": [
                                ...
                                { data: "TWD_P", title: "<%=Resources.MP.Price_TWD%>" },
                                { data: "USD_P", title: "<%=Resources.MP.Price_USD%>" },
                                { data: "Curr", title: "<%=Resources.MP.Currency%>" },
                                { data: "Curr_P", title: "<%=Resources.MP.Price_Curr%>" },
                                { data: "MIN_1", title: "MIN_1" },
                                { data: "LSTP_Day", title: "<%=Resources.MP.Last_Price_Day%>" },
                                { data: "PI", title: "<%=Resources.MP.Product_Information%>" },
                                { data: "Create_Date", title: "<%=Resources.MP.Create_Date%>" },
                                { data: "IMG_Enabele", title: "<%=Resources.MP.IMG_Enable%>" },
                            ...
                            if (Copy_Check()) {
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        ...
                                        "P_USD": parseFloat($('#TB_M2_USD').val()) || 0,
                                        "P_TWD_2": parseFloat($('#TB_M2_TWD_2').val()) || 0,
                                        "P_TWD_3": parseFloat($('#TB_M2_TWD_3').val()) || 0,
                                        "MIN_1": parseFloat($('#TB_M2_MIN_1').val()) || 0,
                                        "MIN_2": parseFloat($('#TB_M2_MIN_2').val()) || 0,
                                        "MIN_3": parseFloat($('#TB_M2_MIN_3').val()) || 0,
                                        "Curr": $('#TB_M2_Currency').val(),
            ...
            function ATC() {
                ...
                $('#TB_I_S_No, #TB_CL_S_No, #TB_MR_S_No, #TB_P_S_No').autocomplete({
                    autoFocus: true,
                    source: function (request, response) {
                        $.ajax({
                            url: "/Web_Service/AutoComplete.asmx/Serach_Supplier_No_Name",
                    ...
                    select: function (event, ui) {
                        $('#TB_I_S_No,     #TB_CL_S_No,    #TB_MR_S_No,    #TB_P_S_No').val(ui.item.value);
                        $('#TB_I_S_SName,  #TB_CL_S_SName, #TB_MR_S_SName, #TB_P_S_SName').val(ui.item.name);
                    },
                });
            };
            function DDL_Bind() {
            ...
            <tr style="text-align: center;">
                <td style="width: 40%;">
                    ...
                    <select style="width: 90%; height: 25px;" id="DDL_Dia_Filter">
                        <option value="[頤坊型號]" selected="selected"><%=Resources.MP.Ivan_Model%></option>
                        <option value="[廠商編號]"><%=Resources.MP.Supplier_No%></option>
                        <option value="[廠商型號]"><%=Resources.MP.Supplier_Model%></option>
                        <option value="[暫時型號]"><%=Resources.MP.Sample_Product_No%></option>
                        ...
                        <option value="[新增日期]"><%=Resources.MP.Add_Date%></option>
    ...
    <div id="Copy_Dialog" style="display:none;">
        <table border="0" style="margin: 0 auto;" id="CD_Table">
            <tr style="background-color:lightgray;">
                ...
                <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Old%><%=Resources.MP.Supplier_Model%></td>
                <td style="text-align: left; width: 15%;">
                    <span id="LB_M2_SM"></span>
                </td>
            </tr>
            <tr style="background-color:lightgray;">
                <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Old%><%=Resources.MP.Supplier_No%></td>
                <td style="text-align: left; width: 15%;">
                    <span id="LB_CD_S_No"></span>
                </td>
                <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Old%><%=Resources.MP.Supplier_Short_Name%></td>
                <td style="text-align: left; width: 15%;">
                    <span id="LB_CD_S_SName"></span>
                </td>
            </tr>
            <tr style="background-color:lightgray;">
                <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Old%><%=Resources.MP.Product_Information%></td>
            ...
            <tr>
                <td style="text-align:right;"><%=Resources.MP.New%><%=Resources.MP.Supplier_No%></td>
                <td style="text-align:left;" colspan="3">
                    <input type="hidden" id="HDN_CD_S_SName" />
                        <div style="width: 90%; float: left; z-index: -10;">
                            <input id="TB_CD_S_No" class="disabled" required="required" disabled="disabled" style="width: 100%;z-index: -10;" />
                        </div>
                        <div style="width: 10%; float: right; z-index: 10; ">
                            <input id="CD_BT_Product_Selector" type="button" value="…" style="float: right; z-index: 10;width:100%;" />
                        </div>
                </td>
            </tr>
        </table>
    ...
    <div style="width: 99%; margin: 0 auto; background-color: white;">
        ...
        <input type="button" class="V_BT" style="display:none;" value="<%=Resources.MP.Change_Log%>" onclick="$('.Div_D').css('display','none');$('#Div_Change_Log').css('display','');" />
        <input type="button" class="V_BT" style="display:none;" value="<%=Resources.MP.More%>" onclick="$('.Div_D').css('display','none');$('#Div_More').css('display','');" />
        <input type="button" class="V_BT" style="display:none;" value="<%=Resources.MP.Package%>" onclick="$('.Div_D').css('display','none');$('#Div_Package').css('display','');" />
        <input type="button" class="V_BT" style="display:none;" value="<%=Resources.MP.Report%>" onclick="$('.Div_D').css('display','none');$('#Div_Report').css('display','');" />
    </div>
        ...
        <div id="Div_M2" class="Div_D">
            <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 8px;">
                <tr>
                    ...
                    <td style="text-align: left; width: 15%;" colspan="3">
                        <input id="TB_M2_IM" class="disabled" autocomplete="off" required="required" disabled="disabled" style="width: 100%;" />
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: left; width: 15%;" colspan="3">
                        <div style="width: 90%; float: left; z-index: -10;">
                            <input id="TB_M2_S_No" class="disabled" required="required" disabled="disabled" style="width: 100%;z-index: -10;" />
                        </div>
                ...
                <tr>
                    ...
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Price_TWD%>_2</td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_M2_TWD_2" disabled="disabled" type="number" value="0" style="width: 100%;text-align:right;" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Price_TWD%>_3</td>
                    <td style="text-align: left; width: 15%;">
                ...
                <tr>
                    ...
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Price_Curr%>_2</td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_M2_PC_2" disabled="disabled" type="number" value="0" style="width: 100%;text-align:right;" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Price_Curr%>_3</td>
                    <td style="text-align: left; width: 15%;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Design_Person%></td>
                    <td style="text-align: left; width: 15%;" colspan="3">
                    ...
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Design_Image%></td>
                    <td style="text-align: left; width: 15%;" colspan="3">
                ...
                <tr class="M2_For_U" style="display:none;">
                    ...
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Combination%></td>
                    <td style="text-align: left; width: 15%;">
        ...
        <div id="Div_Image" class="Div_D" style="display: none; overflow: auto;">
            <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 8px;">
                <tr>
                    ...
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Supplier_No%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_I_S_No" class="disabled" disabled="disabled" style="width: 100%;" placeholder="<%=Resources.MP.S_No_ATC_Hint%>" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Supplier_Short_Name%></td>
                    <td style="text-align: left; width: 15%;">
        ...
        <div id="Div_Change_Log" class="Div_D" style="display: none; overflow: auto;">
            <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 10px;">
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Ivan_Model%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_CL_IM" class="disabled" disabled="disabled" style="width: 100%;" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Supplier_No%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_CL_S_No" class="disabled" disabled="disabled" style="width: 100%;" placeholder="<%=Resources.MP.S_No_ATC_Hint%>" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Supplier_Short_Name%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_CL_S_SName" class="disabled" disabled="disabled" style="width: 100%;" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Product_Information%></td>
                    <td style="text-align: left; width: 15%;" colspan="7">
                        <input id="TB_CL_P_IM" class="disabled" disabled="disabled" style="width: 100%;" />
                    </td>
                </tr>
                <tr>
        ...
        <div id="Div_More" class="Div_D" style="display: none; overflow: auto">
            <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 10px;">
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Ivan_Model%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_MR_IM" class="disabled" disabled="disabled" style="width: 100%;" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Supplier_No%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_MR_S_No" class="disabled" disabled="disabled" style="width: 100%;" placeholder="<%=Resources.MP.S_No_ATC_Hint%>" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Supplier_Short_Name%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_MR_S_SName" class="disabled" disabled="disabled" style="width: 100%;" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Product_Information%></td>
                    <td style="text-align: left; width: 15%;" colspan="7">
                        <input id="TB_MR_P_IM" class="disabled" disabled="disabled" style="width: 100%;" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Manufacture_Spec%></td>
                    <td style="text-align: left; width: 15%;" colspan="7">
                ...
                <tr>
                    ...
                    <td style="text-align: center; width: 25%;text-wrap: none;" colspan="2">
                        ...
                        <label for="TB_MR_DPN"><%=Resources.MP.Developing%></label>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div id="Div_Package" class="Div_D" style="display: none; overflow: auto;">
            <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 10px;">
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Ivan_Model%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_P_IM" class="disabled" disabled="disabled" style="width: 100%;" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Supplier_No%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_P_S_No" class="disabled" disabled="disabled" style="width: 100%;" placeholder="<%=Resources.MP.S_No_ATC_Hint%>" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Supplier_Short_Name%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_P_S_SName" class="disabled" disabled="disabled" style="width: 100%;" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Product_Information%></td>
                    <td style="text-align: left; width: 15%;" colspan="7">
                        <input id="TB_P_P_IM" class="disabled" disabled="disabled" style="width: 100%;" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Working_Hours%></td>
                    <td style="text-align: left; width: 15%;">
                    ...
                    <td colspan="8">
                        <div style="position: relative; border: 1px solid #111111; padding: 20px; box-sizing: border-box; margin: 30px auto; width: 100%;">
                            ...
                            <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 10px;">
                                ...
                                <tr>
                                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Product_Length%></td>
                                    <td style="text-align: left; width: 15%;">
                                        <input id="TB_P_PL" type="number" value="0" autocomplete="off" disabled="disabled" style="width: 100%;" />
                                    </td>
                                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Product_Weight%></td>
                                    <td style="text-align: left; width: 15%;">
                                        <input id="TB_P_PW" type="number" value="0" autocomplete="off" disabled="disabled" style="width: 100%;" />
                                    </td>
                                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Product_Height%></td>
                                    <td style="text-align: left; width: 15%;">
                                        <input id="TB_P_PH" type="number" value="0" autocomplete="off" disabled="disabled" style="width: 100%;" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Package_Length%></td>
                                    <td style="text-align: left; width: 15%;">
                                        <input id="TB_P_PGL" type="number" value="0" autocomplete="off" disabled="disabled" style="width: 100%;" />
                                    </td>
                                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Package_Weight%></td>
                                    <td style="text-align: left; width: 15%;">
                                        <input id="TB_P_PGW" type="number" value="0" autocomplete="off" disabled="disabled" style="width: 100%;" />
                                    </td>
                                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Package_Height%></td>
                                    <td style="text-align: left; width: 15%;">
