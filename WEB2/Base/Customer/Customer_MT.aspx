<%@ Page Title="Customer Maintenance" Language="C#" MasterPageFile="~/MP.master" AutoEventWireup="true" CodeFile="Customer_MT.aspx.cs" Inherits="Customer_Customer_MT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            function Table_Tr_Click(Click_tr) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response[0].C_Marks_File_Name != null) {
                    ...
                    success: function (response) {
                        $('#Table_Search_Customer').DataTable({
                            ...
                            "columns": [
                                ...
                                { data: "C_Principal", title: "<%=Resources.MP.Principal%>" },
                                { data: "C_Payment_Terms", title: "<%=Resources.MP.Payment_Terms%>" },
                                { data: "C_Person_Commodity", title: "<%=Resources.MP.Person_Commodity%>" },
                                { data: "C_Quote", title: "<%=Resources.MP.Quote_Class%>" },
                                { data: "C_Currency", title: "<%=Resources.MP.Currency%>" },
                                { data: "C_Person_Sample", title: "<%=Resources.MP.Person_Sample%>" },
                                { data: "C_Price_Condition", title: "<%=Resources.MP.Price_Condition%>" },
                                { data: "C_Web", title: "<%=Resources.MP.Web%>" },
                                { data: "C_Mail", title: "Mail" },
                                { data: "C_IV_Address", title: "<%=Resources.MP.IV_Address%>" },
                                { data: "C_Costomer_Source", title: "<%=Resources.MP.Customer_Source%>" },
                                { data: "C_Reference_Number", title: "<%=Resources.MP.Reference_Number%>" },
                                { data: "C_Company_Address", title: "<%=Resources.MP.Company_Address%>" },
                                { data: "C_Factory_Address", title: "<%=Resources.MP.Factory_Address%>" },
                                { data: "C_Delivery_Address", title: "<%=Resources.MP.Delivery_Address%>" },
    ...
    <div id="dialog" style="display: none;">
        ...
        <table border="0" style="margin: 0 auto;" id="Dia_Table_Simple">
            <tr style="text-align: right;">
                <td style="width: 20%;"><%=Resources.MP.Customer_No%></td>
                <td style="width: 30%;">
            ...
            <tr style="text-align: right;">
                <td style="width: 20%;"><%=Resources.MP.Customer_Short_Name%></td>
                <td style="width: 30%;">
            ...
            <tr style="text-align: center;">
                <td style="width: 40%;">
                    ...
                    <select style="width: 90%; height: 25px;" id="DDL_Dia_Filter">
                        <option value="[客戶編號]" selected="selected"><%=Resources.MP.Customer_No%></option>
                        <option value="[客戶簡稱]"><%=Resources.MP.Customer_Short_Name%></option>
                        <option value="[國名]"><%=Resources.MP.Nation%></option>
                        <option value="[客戶來源]"><%=Resources.MP.Customer_Source%></option>
                        <option value="[報價等級]"><%=Resources.MP.Quote_Class%></option>
                        <option value="[參考號碼]"><%=Resources.MP.Reference_Number%></option>
                        <option value="[初接觸日]"><%=Resources.MP.First_Contact%></option>
                        ...
                        <option value="[連絡人大貨]"><%=Resources.MP.Person_Commodity%></option>
                        <option value="[連絡人樣本]"><%=Resources.MP.Person_Sample%></option>
    ...
    <div style="width: 99%; margin: 0 auto; background-color: white;">
        ...
        <input type="button" class="V_BT" style="display:none;" value="<%=Resources.MP.Customs_Clearance%>" onclick="$('.Div_D').css('display','none');$('#Div_Customs_Clearance').css('display','');" />
        <input type="button" class="V_BT" style="display:none;" value="<%=Resources.MP.Marks%>" onclick="$('.Div_D').css('display','none');$('#Div_Marks').css('display','');" />
        <input type="button" class="V_BT" style="display:none;" value="<%=Resources.MP.Reference%>" onclick="$('.Div_D').css('display','none');$('#Div_Reference').css('display','');" />
    ...
    <div style="width: 100%;" id="Div_Detail_Form">
        <div id="Div_M2" class="Div_D">
            <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 8px;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Quote_Class%></td>
                    <td style="text-align: left; width: 15%;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Price_Condition%></td>
                    <td style="text-align: left; width: 15%;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.IV_Address%></td>
                    <td style="text-align: left; width: 15%;">
                ...
                <tr class="M2_For_N" style="display:none;">
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Reference_Number%></td>
                    <td style="text-align: left; width: 15%;">
        ...
        <div id="Div_Marks" class="Div_D" style="display: none; overflow: auto;">
            <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 10px;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Marks%></td>
                    <td style="text-align: left; width: 15%;">
                ...
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Packag_Request%></td>
                    <td style="text-align: left;" colspan="3">
        ...
        <div id="Div_Reference" class="Div_D" style="display: none; overflow: auto;">
            <table style="font-size: 15px; border-collapse: separate; border-spacing: 0px 20px;">
                ...
                <tr>
                    ...
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.First_Contact%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_RF_First_Contact" type="date" disabled="disabled" style="width: 100%;" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Person_Finance%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_RF_Person_Finance" disabled="disabled" style="width: 100%;" />
                    </td>
                    <td style="text-align: right; text-wrap: none; width: 10%;color:red;"><%=Resources.MP.Person_Purchase%></td>
                    <td style="text-align: left; width: 15%;">
                        <input id="TB_RF_Person_Purchase" disabled="disabled" style="width: 100%;" />
                    </td>
                </tr>                
                <tr>
                    <td style="text-align: right; text-wrap: none; width: 10%;"><%=Resources.MP.Finance_Mail%></td>
                    <td style="text-align: left;" colspan="3">
